...
/* USER CODE BEGIN PV */
const uint16_t SineWave12bit[DAC_NUM]={
...
uint16_t adc_buff[ADC_NUM];
uint16_t dac_buff[DAC_NUM];
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	HAL_ADC_Start_DMA(&hadc1, (uint32_t *)adc_buff, ADC_NUM);
