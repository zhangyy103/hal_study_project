...
int main(void)
{
  ...
  setRotation(0);
  char badmpu[] = "hello";
  fillScreen(ILI9488_YELLOW);
	HAL_Delay(1000);
	fillRect(100, 100, 110, 110, ILI9488_RED);


  writeLine(0, 0, 320, 480, ILI9488_BLUE);
	HAL_Delay(1000);
  ...
  ILI9488_printText(badmpu,10,100,ILI9488_RED,ILI9488_WHITE,4);
